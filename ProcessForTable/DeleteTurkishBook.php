...
createTable("Türkçe Kitap silme Tablosu",  $tableName,
$languageValue,
...
?> <tr>
            ...
            <td><label style="margin: auto; padding-left:30%"><?php  echo "%".(int)($var['TotalReadPage']*100 /$var['TotalPage']); ?></label> 
            <meter  style="width: 100%; padding-right:10%" value="<?php  echo $var['TotalReadPage']; ?>" max="<?php echo $var['TotalPage'];?>"> </meter>
        </td>
